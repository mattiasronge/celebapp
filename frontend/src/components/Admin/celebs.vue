                                ...
                                <div class="col s12" v-for="(Celeb, idx) in Celebs" :key="idx">
                                    ...
                                    <div class="input-group m-b-5">
                                        ...
                                        <!--span class="input-group-addon addon-right">
                                            <input type="checkbox" v-on:click="deleteData(Celeb._id)"/></span-->
                                        <a href="#"><span class="input-group-addon addon-left" title="Have you seen?"
                                            v-on:click="seenItem(Celeb._id)"><i class="material-icons">star_border</i></span></a>
    ...
    export default {
        ...
        methods: {
            ...
            fetchData() {
                ...
                let uri = 'http://localhost:3000/celebs/all';
            ...
            seenItem(id) {
                ...
                let uri = 'http://localhost:3000/celebs/seen/' + id;
